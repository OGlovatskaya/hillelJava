...
public class HomeWork {
    ...
    public static void rectangle() {
        ...
        if (discriminant < 0) {
            System.out.println("HomeWork4.Rectangle with such parameters does not exist");

        } else {
            rectangleLength = ((halfPerimeter * (-1)) + Math.sqrt(discriminant)) / 2;
            rectangleHeight = ((halfPerimeter * (-1)) - Math.sqrt(discriminant)) / 2;
            System.out.println("HomeWork4.Rectangle length is " + rectangleLength);
            System.out.println("HomeWork4.Rectangle height is " + rectangleHeight);
        }
